...
const privacyData = {
  ...
  description:
    "We're excited to be part of your wedding journey — and we take your privacy just as seriously as your big day.",
  sections: [
    {
      title: "1. Who We Are",
      content:
        "Poornam Events is a wedding and event planning company based in Indore, Madhya Pradesh. Our website address is:",
    ...
    },
    {
      ...
      content:
        "Our services are not directed to children under 13. We do not knowingly collect data from minors. If you believe a child has provided us data, please contact us immediately.",
    },
    {
      title: "8. Your Rights (For Indian Users)",
      content:
        "Under applicable laws (including the Digital Personal Data Protection Act, India):",
      items: [
    ...
    },
    {
      ...
      content:
        "Our website may contain links to Instagram, YouTube, Pinterest, or vendor websites. We are not responsible for the privacy practices of those external sites.",
    },
    {
      title: "10. Changes to This Policy",
      content:
        'We may update this policy from time to time. When we do, we\'ll revise the "Last Updated" date at the top. Please review this page occasionally to stay informed.',
    },
    {
      title: "Contact Us",
      content:
    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <StyledPaper elevation={3}>
          ...
          <Typography variant="body1">{privacyData.description}</Typography>
