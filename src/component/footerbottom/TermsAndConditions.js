...
const termsData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        "Our refund and cancellation terms vary by service and are detailed in your signed event contract. However:",
      items: [
    ...
    },
    {
      ...
      content:
        "Our site may link to wedding vendors, social media platforms (Instagram, YouTube, Pinterest), or affiliate blogs. We do not control or endorse their content or policies.",
      note: "Use third-party links at your own discretion.",
    },
    {
      title: "7. Website Accuracy & Availability",
      content:
        "We strive to keep all information updated and correct. However:",
      items: [
    ...
    },
    {
      ...
      content:
        "Poornam Events shall not be liable for any direct, indirect, incidental, or special damages arising from:",
      items: [
    ...
    },
    {
      ...
      content:
        "These Terms are governed by the laws of India. Any disputes will be subject to the exclusive jurisdiction of the courts of Indore, Madhya Pradesh.",
    },
    {
      title: "10. Contact Us",
      content:
