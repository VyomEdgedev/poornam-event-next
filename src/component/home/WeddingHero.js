    ...
    >
      <Box sx={{ flex: 1, maxWidth: { sm: "100%", md: "40%" }}}>
        ...
        <Typography
          variant="body1"
          component="p"
          sx={{ mb: 2, frontFamily: "Akatab,Sans-serif",color: "#000D1F", fontWeight: 400 , lineHeight: 1.3, fontSize:{xs:"16px", sm:"16px", md:"16px", lg:"18px"}}}
        >
        ...
        <Typography  variant="body1"
          component="p" sx={{ frontFamily: "Akatab,Sans-serif",color: "#000D1F",  fontWeight: 400,
            lineHeight: 1.3, fontSize:{xs:"16px", sm:"16px", md:"16px", lg:"18px"}  }}>
